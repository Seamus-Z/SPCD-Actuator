...
filegroup(
    ...
    srcs = glob([
        "include/c++/**",
        # New-scheme tarballs (LLVM 19+) put per-target libc++ headers (notably
        # __config_site) under include/<triple>/c++/v1.
        "include/*/c++/**",
...
filegroup(
    ...
    srcs = glob(
        [
            "lib/lib*.a",
            # New-scheme tarballs ship the C++ runtime under a per-triple dir.
            "lib/*-linux-gnu/lib*.a",
            # LLVM 16+ uses lib/clang/<major>; older versions use lib/clang/<full>.
            "lib/clang/%{llvm_version}/lib/**/*.a",
            "lib/clang/%{llvm_major_version}/lib/**/*.a",
        ],
        exclude = [
            "lib/libLLVM*.a",
            "lib/libclang*.a",
